# Generated by Django 4.2.11 on 2024-03-27 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_license_plate', models.CharField(blank=True, max_length=255, null=True)),
                ('car_price', models.IntegerField()),
                ('car_image', models.ImageField(blank=True, null=True, upload_to='uploads/cars')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver_email', models.EmailField(blank=True, max_length=255, null=True)),
                ...
                ('driver_license_valid_id', models.ImageField(blank=True, null=True, upload_to='uploads/license')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('customer_license_valid_id', models.ImageField(blank=True, null=True, upload_to='uploads/license')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_status', models.CharField(blank=True, max_length=255, null=True)),
                ('toll_fee', models.IntegerField()),
                ('booking_total_price', models.IntegerField()),
                ('is_pickup', models.BooleanField(default=False)),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rental.cars')),
